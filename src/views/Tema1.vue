  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal
      .titulo-principal__numero
        span 1
      h1 Intereses y acuerdos
    .cajon-b.color-acento-contenido.p-4.mb-5
      p.mb-0 Desde el momento en que se interactúa con otras personas, se están generando procesos de negociación. Esto implica una decisión que involucra a otros, ya sea a nivel personal o profesional. Cuando se debe elegir en familia un lugar para ir de vacaciones o en el momento en que con los compañeros deciden cómo trabajar para un objetivo común propuesto… se está negociando. 
    p La negociación es un proceso cotidiano, así como los seres humanos se pasan la vida negociando sin darse cuenta de ello. 
    p.mb-5 La negociación se genera cuando:
    .row.mb-5.justify-content-between.px-5
      .col-lg-1
      ...
      .col-lg-1
    p Aprender a reconocer la importancia de la negociación y sus elementos, así como identificar los intereses y las alternativas, permitirá que el emprendedor pueda generar relaciones de éxito para llevar a cabo sus objetivos aprovechando sus habilidades personales en pro de estos. 
    .row.mb-5.align-items-center
      .col-lg-6
        p De acuerdo con lo anterior:
        p ¿Cuáles serían los elementos de la negociación? 
        p ¿Por qué son fundamentales?
    ...
    p La relación es un elemento que precede a la negociación, es decir antes de iniciar el proceso, posiblemente, ya se tiene un vínculo con quien va a negociar. 
    .row.align-items-center.mx-4
      .col-lg-5
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg-6
        .tarjeta.fcp25.p-4
          h4 Necesidades
          p.mb-0 Elementos indispensables para sobrevivir.
        .tarjeta.fcp25.p-4
          h4 Valores
          p.mb-0 Se encuentran en la profundidad de los intereses y deben tenerse en cuenta.
        .tarjeta.fcp25.p-4
          h4 Preocupaciones
          p.mb-0 Son cuestiones presentes o futuras que inquietan a alguna de las partes. Pueden ser sencillas de solucionar si la otra parte puede solventarlas.
        .tarjeta.fcp25.p-4
          h4 Temores
          p.mb-0 Se podrían definir como grandes preocupaciones y suelen ser un obstáculo importante pues puede impedir que la negociación se lleve a cabo.
        .tarjeta.fcp25.p-4
          h4 Deseos
          p.mb-0 Son los aspectos anhelados por las partes que cuando se obtienen generan gran satisfacción.
    p.mb-5 Identificar los intereses propios y los de la otra parte permitirá encontrar puntos en común para llegar a un buen acuerdo.
    .contenedor.mx_5.fcp25.p-5
      .col-lg-10.mx-auto.row.align-items-center
        .col-lg-6
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg-9
        p ¿El acuerdo es mejor que las alternativas que había generado? 
        p ¿El acuerdo satisface ambas partes?
        p ¿El acuerdo es legal? 
        p.mb-5 ¿El acuerdo mejora la relación entre las partes?
        .tarjeta.g1.p-3.mb-5
          .row.justify-content-around.align-items-center
            .col-3.col-sm-2.col-lg-1
              img(src='@/assets/curso/t1/f13.svg' alt='Imagen relacionada')
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h3.mb-1 Video El método Harvard de negociación y sus 7 elementos
                  p.text-small Recomendamos ver el siguiente video que describe el método Harvard de negociación, como un importante método simple y estructurado que describe los siete aspectos básicos para llevar la negociación a un feliz término.
                .col-sm-auto
